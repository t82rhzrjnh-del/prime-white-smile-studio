...
export default function PrimeSmileStudio() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
      ...
      <SectionWrapper id="pricing" bg="#FFFFFF">
        ...
        <RevealGroup className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 max-w-4xl mx-auto items-start" delay={180}>
          <div className="pricing-card border rounded-none p-8 md:p-10 flex flex-col items-center text-center h-full" style={{ borderColor: "rgba(197,165,90,0.25)" }}>
            ...
            <p className="font-sans-elegant text-xs font-light leading-relaxed flex-1" style={{ color: "#888" }}>
              Our full whitening treatment. Perfect for first-timers or anyone wanting maximum results.
            </p>
            <button onClick={() => scrollTo("booking")} className="outline-btn mt-8 font-sans-elegant text-xs uppercase tracking-[0.2em] font-medium py-3 px-8 rounded-none">
              Book Now
            </button>
          </div>

          <div className="pricing-card relative border-2 rounded-none p-8 md:p-10 flex flex-col items-center text-center md:-mt-4 h-full" style={{ borderColor: "#C5A55A", background: "linear-gradient(180deg, #FDFBF7 0%, #FFFFFF 100%)" }}>
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 gold-gradient text-white font-sans-elegant text-[10px] uppercase tracking-[0.25em] font-semibold px-5 py-1.5 whitespace-nowrap">
              Best Value
            </div>
      ...
      <SectionWrapper id="results" bg="#FDFBF7">
        ...
        <RevealGroup className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-4xl mx-auto" delay={140}>
          {[
            { src: "/ba-1.jpeg", label: "Client 1" },
            { src: "/ba-2.jpeg", label: "Client 2" },
            { src: "/ba-3.jpeg", label: "Client 3" },
            { src: "/ba-4.jpeg", label: "Client 4" },
            { src: "/ba-5.jpeg", label: "Client 5" },
          ].map((item, i) => (
          ...
          <Reveal direction="right">
            <div className="text-center md:text-left flex flex-col items-center md:items-start">
              ...
              <div className="mt-10 flex items-center gap-4">
                <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: "rgba(197,165,90,0.1)" }}>
